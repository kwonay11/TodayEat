...
const qnaList = [
    {
      ...
      },
      {
        ...
        a: [
          ...
          { answer: 'b. 고기 별로 안 땡겨..', type: [0,1,9,10,11,12] },
        ]
      },
      {
        q: '4. 면을 먹고 싶다? 아니다',
  ...
  const infoList = [
    ...
    {
      name: '훠궈',
      desc: '백탕, 홍탕 두 탕애서 무엇을 넣어 먹을까? 기대가 되는 훠궈!! 골라 넣어 먹을 수 있는 맛좋은 훠궈. 너 당첨이다!'
    },
    {
      name: '딤섬',
    ...
    {
      name: '치킨',
      desc: '누가 뭐래도 치킨은 치킨이지!! 남녀노소 가리지 않는 치킨!! 가장 대표적인 맛있는 음식. 날 위해 보상해줄까? 튀긴 치킨, 구운 치킨 뭘 먹어볼까?'
    },
    {
      name: '짜장면',
